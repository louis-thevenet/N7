...
procedure Exemples_Memoire_Dynamique is
	...
	begin
		...
		-- on sait Quelle est la valeur de Ptr2.all ?
		...
		-- Non A-t-on le droit de manipuler Ptr2.all ?
		-- Lecture interdite mais pas de fuite Que se passe-t-il si on exécute le programme avec valgrind ?
		--
	...
	begin
		...
		Ptr.all := 111;
		SP (Ptr);
		-- 123 Quelle est la valeur de Ptr.all ?
	...
	begin
		...
		-- oui P étant une variable locale du sous-programme, a-t-on besoin
