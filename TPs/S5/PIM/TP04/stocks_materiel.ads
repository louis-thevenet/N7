...
package Stocks_Materiel is
    ...
    type T_Materiels_Liste is array(1..CAPACITE) of T_Materiel;
...
private type T_Stock is
    record
        Materiels : T_Materiels_Liste;
        Nombre_Materiels : Integer; --{Nombre_Materiels <= CAPACITE}
    end record;
