...
(******************************************************************************)
let appartient mot (Trie(arbre, decompose, _) ) = appartient_arbre (decompose mot) arbre
...
(******************************************************************************)
let retrait mot (Trie(arbre, decompose, compose))= Trie(retrait_arbre (decompose mot) arbre, decompose, compose)

let%test _ = not (appartient "maison" (retrait "maison" trie_sujet))
