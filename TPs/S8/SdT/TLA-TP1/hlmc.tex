...
\@x{}\moduleLeftDash\@xx{ {\MODULE} hlmc}\moduleRightDash\@xx{}%
\@x{}%
\@y{\@s{0}%
 Time-stamp: \ensuremath{\.{<}09} oct 2024 11:54 \ensuremath{Philippe}
 \ensuremath{Queinnec\.{>}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Le problème de l\mbox{'}homme, du \ensuremath{loup}, du \ensuremath{mouton}
 et du \ensuremath{chou
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
...
\@x{\@s{8.2}}%
\@y{\@s{0}%
 la barque est inutile, car elle est avec l\mbox{'}homme.
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Rives \.{\defeq} \{\@w{G} ,\,\@w{D} \}}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{8.2} {\Box} ( \.{\land} homme \.{\in} Rives}%
\@x{\@s{19.77} \.{\land} loup \.{\in} Rives}%
\@x{\@s{19.77} \.{\land} mouton \.{\in} Rives}%
\@x{\@s{19.77} \.{\land} chou \.{\in} Rives )}%
\@pvspace{8.0pt}%
\@x{ pasMiam \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} ( loup\@s{2.18} \.{=} mouton \.{\implies} homme \.{=}
 loup )}%
\@x{\@s{16.4} \.{\land} ( chou \.{=} mouton \.{\implies} homme \.{=} chou )}%
\@pvspace{8.0pt}%
\@x{ ToujoursOk \.{\defeq} {\Box} pasMiam}%
\@pvspace{8.0pt}%
\@x{ Solution \.{\defeq}}%
 \@x{\@s{8.2} {\Box} {\neg} ( homme \.{=}\@w{D} \.{\land} loup \.{=}\@w{D}
 \.{\land} mouton \.{=}\@w{D} \.{\land} chou \.{=}\@w{D} )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
 \@x{ inv ( r ) \.{\defeq} {\IF} r \.{=}\@w{G} \.{\THEN}\@w{D}
 \.{\ELSE}\@w{G}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{8.2} \.{\land} homme \.{=}\@w{G}}%
\@x{\@s{8.2} \.{\land} loup \.{=}\@w{G}}%
\@x{\@s{8.2} \.{\land} mouton \.{=}\@w{G}}%
\@x{\@s{8.2} \.{\land} chou \.{=}\@w{G}}%
\@pvspace{8.0pt}%
\@x{ bougeHomme \.{\defeq}}%
\@x{\@s{8.2} \.{\land} homme \.{'} \.{=} inv ( homme )}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} loup ,\, mouton ,\, chou
 {\rangle}}%
\@x{\@s{8.2} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{ bougeLoup \.{\defeq}}%
\@x{\@s{8.2} \.{\land} loup \.{=} homme}%
\@x{\@s{8.2} \.{\land} homme \.{'} \.{=} inv ( homme )}%
\@x{\@s{8.2} \.{\land} loup \.{'} \.{=} inv ( loup )}%
\@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} mouton ,\, chou {\rangle}}%
\@x{\@s{8.2} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{ bougeMouton \.{\defeq}}%
\@x{\@s{8.2} \.{\land} mouton\@s{1.25} \.{=} homme}%
\@x{\@s{8.2} \.{\land} homme \.{'} \.{=} inv ( homme )}%
\@x{\@s{8.2} \.{\land} mouton \.{'} \.{=} inv ( mouton )}%
\@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} loup ,\, chou {\rangle}}%
\@x{\@s{8.2} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{ bougeChou \.{\defeq}}%
\@x{\@s{8.2} \.{\land} chou \.{=} homme}%
\@x{\@s{8.2} \.{\land} homme \.{'} \.{=} inv ( homme )}%
\@x{\@s{8.2} \.{\land} chou \.{'} \.{=} inv ( chou )}%
\@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} mouton ,\, loup {\rangle}}%
\@x{\@s{8.2} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} bougeHomme \.{\lor} bougeLoup \.{\lor}\@s{4.1}
 bougeMouton \.{\lor} bougeChou}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle}
 homme ,\, loup ,\, mouton ,\, chou {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
