...
\@x{}\moduleLeftDash\@xx{ {\MODULE} hlmc2}\moduleRightDash\@xx{}%
\@x{}%
\@y{\@s{0}%
 Time-stamp: \ensuremath{\.{<}09} oct 2024 11:53 \ensuremath{Philippe}
 \ensuremath{Queinnec\.{>}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 Le problème de l\mbox{'}homme, du loup, du mouton et du chou
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Entites \.{\defeq} \{\@w{H} ,\,\@w{L} ,\,\@w{M} ,\,\@w{C} \}}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{8.2} {\Box} ( \.{\land} posG\@s{0.09} \.{\subseteq} Entites}%
\@x{\@s{19.77} \.{\land} posD \.{\subseteq} Entites}%
\@x{\@s{19.77} \.{\land} posG \.{\cap} posD \.{=} \{ \}}%
\@x{\@s{19.77} \.{\land} posG \.{\cup} posD \.{=} Entites )}%
\@pvspace{8.0pt}%
\@x{ pasMiam1 ( pos ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} ( \{\@w{L} ,\,\@w{M} \}\@s{0.97} \.{\subseteq} pos
 \.{\implies}\@w{H} \.{\in} pos )}%
 \@x{\@s{16.4} \.{\land} ( \{\@w{C} ,\,\@w{M} \} \.{\subseteq} pos
 \.{\implies}\@w{H} \.{\in} pos )}%
\@pvspace{8.0pt}%
\@x{ pasMiam \.{\defeq}}%
\@x{\@s{8.2} pasMiam1 ( posG ) \.{\land} pasMiam1 ( posD )}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{8.2} \.{\land} posG \.{=} Entites}%
\@x{\@s{8.2} \.{\land} posD\@s{0.11} \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{ bougeGD ( S ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} S \.{\subseteq} posG}%
\@x{\@s{8.2} \.{\land}\@w{H} \.{\in} S}%
\@x{\@s{8.2} \.{\land} Cardinality ( S ) \.{\leq} 2}%
\@x{\@s{8.2} \.{\land} posG \.{'} \.{=} posG \.{\,\backslash\,} S}%
\@x{\@s{8.2} \.{\land} posD \.{'}\@s{0.11} \.{=} posD \.{\cup} S}%
\@x{\@s{8.2} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{ bougeDG ( S ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} S \.{\subseteq} posD}%
\@x{\@s{8.2} \.{\land}\@w{H} \.{\in} S}%
\@x{\@s{8.2} \.{\land} Cardinality ( S ) \.{\leq} 2}%
\@x{\@s{8.2} \.{\land} posD \.{'}\@s{0.11} \.{=} posD \.{\,\backslash\,} S}%
\@x{\@s{8.2} \.{\land} posG \.{'} \.{=} posG \.{\cup} S}%
\@x{\@s{8.2} \.{\land} pasMiam \.{'}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \E\, s \.{\in} {\SUBSET} Entites \.{:}}%
\@x{\@s{48.03} bougeGD ( s ) \.{\lor} bougeDG ( s )}%
\@pvspace{16.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} posG
 ,\, posD {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
