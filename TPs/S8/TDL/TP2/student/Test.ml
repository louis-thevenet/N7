...
let%test _ = ( getValeur (miniML "../../exemples/exemple-15.mml") = (IntegerValue 63) )
...
let%test _ = ( getType (miniML "../../exemples/exemple-09.mml") = (FunctionType(UnknownType,UnknownType)))
