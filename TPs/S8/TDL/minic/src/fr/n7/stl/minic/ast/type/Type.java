...
public interface Type {
	 ...
	 * Check that the self type is compatible with the _other type, i.e. all values
	 * of self can be
	...
	/**
	 * Builds a new type that results from the merging of self and _other according
	 ...
	 * 
	 * @param _other The other type.
	 * @return A type that is the least upper bound of self and _other according to
	 *         compatibleWith.
	 */
