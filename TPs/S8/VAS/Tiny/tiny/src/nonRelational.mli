...
(** A module type for non relational domains and a functor to build relational
    domains from them (by pointwise extension). *)
...
(** Functor to build relational domains from non relational ones (by pointwise
    extension). *)
